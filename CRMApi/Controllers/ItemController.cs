    ...
    public class ItemController : ControllerBase
    {
        ...
        public IActionResult GetViewOption() 
        {
            ...
            try 
            {
                ...
                objMsg = RepoItem.GetViewOption(User);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public IActionResult GetAddOption(Item obj)
        {
            Message objMsg = new Message();
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.GetAddOption(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Get(Item obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPost]
        public IActionResult Print(Item obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.Print(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Export(Item obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.Export(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Update(Item obj)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.Update(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Delete(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.Delete(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Enable(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItem.Enable(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
