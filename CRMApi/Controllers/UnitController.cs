...
namespace CRMApi.Controllers
{
    ...
    public class UnitController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Get(Unit obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPost]
        public IActionResult Print(Unit obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoUnit.Print(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Export(Unit obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoUnit.Export(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Add(Unit obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPatch]
        public IActionResult Update(Unit obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoUnit.Update(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Delete(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoUnit.Delete(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Enable(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoUnit.Enable(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
