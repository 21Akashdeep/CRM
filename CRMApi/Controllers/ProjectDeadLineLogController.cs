...
namespace CRMApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ProjectDeadLineLogController : ControllerBase
    {
        private readonly DBCRM db;
        private readonly RepoProjectDeadLineLog RepoDept;
        public ProjectDeadLineLogController(DBCRM _db)
        {
            db = _db;
            RepoDept = new RepoProjectDeadLineLog(db);
        }
        [HttpGet]
        ...
        [HttpPost]
        public IActionResult Get(ProjectDeadLineLog obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPost]
        public IActionResult Print(ProjectDeadLineLog obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPost]
        public IActionResult Export(ProjectDeadLineLog obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        [HttpPost]
        public IActionResult Add(ProjectDeadLineLog obj)
        {
            Message objMsg = new Message();
            try
            {
        ...
        public IActionResult Edit(int Id)
        {
            ...
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                ProjectDeadLineLog obj = new ProjectDeadLineLog();
                obj.ListId.Add(Id);
        ...
        [HttpPatch]
        public IActionResult Update(ProjectDeadLineLog obj)
        {
            Message objMsg = new Message();
            try
            {
