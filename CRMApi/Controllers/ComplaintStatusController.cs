    ...
    public class ComplaintStatusController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAddOption()
        {
            ...
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                //objMsg = await RepoComplaintStatus.GetAddOptionAsync(null, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public async Task<IActionResult> GetUser(int DepartmentId) 
        {
            ...
            try 
            {
                //objMsg = await RepoComplaintStatus.GetUserAsync(DepartmentId);
            }
            catch (Exception ex) 
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public async Task<IActionResult> GetComplaintSchedule(ComplaintSchedule obj)
        {
            Message objMsg = new Message();
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                objMsg = await RepoComplaintStatus.GetComplaintScheduleAsync(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public async Task<IActionResult> Print(ComplaintStatus obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                //objMsg = await RepoComplaintStatus.PrintAsync(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public async Task<IActionResult> Export(ComplaintStatus obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                //objMsg = await RepoComplaintStatus.ExportAsync(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public async Task<IActionResult> Edit(int Id)
        {
            ...
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                //objMsg = await RepoComplaintStatus.EditAsync(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPatch]
        public async Task<IActionResult> Update(ComplaintStatus obj)
        {
            Message objMsg = new Message();
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                //objMsg = await RepoComplaintStatus.UpdateAsync(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
