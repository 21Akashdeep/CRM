...
namespace CRMApi.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ItemSubGroupController : ControllerBase
    {
        private readonly DbCRM db;
        private RepoItemSubGroup RepoItemSubGroup;
        public ItemSubGroupController(DbCRM _db)
        {
            db = _db;
        ...
        public IActionResult GetViewOption()
        {
            ...
            try
            {
                ...
                objMsg = RepoItemSubGroup.GetViewOption();
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetAddOption()
        {
            ...
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                objMsg = RepoItemSubGroup.GetAddOption();
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Get(ItemSubGroup obj)
        {
            Message objMsg = new Message();
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                objMsg = RepoItemSubGroup.Get(obj, User);
        ...
        [HttpPost]
        public IActionResult Print(ItemSubGroup obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);
                objMsg = RepoItemSubGroup.Print(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Export(ItemSubGroup obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);                
                objMsg = RepoItemSubGroup.Export(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPost]
        public IActionResult Add(ItemSubGroup obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);                
                objMsg = RepoItemSubGroup.Add(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Edit(int Id)
        {
            ...
            try
            {
                var User = Util.RequestVerify(new Request { HttpRequest = Request, ActionType = ActionType.View }, db, ref objMsg);
                if (User == null) return Ok(objMsg);
                objMsg = RepoItemSubGroup.Edit(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        [HttpPatch]
        public IActionResult Update(ItemSubGroup obj)
        {
            Message objMsg = new Message();
            try
            {
                ...
                if (User == null) return Ok(objMsg);                
                objMsg = RepoItemSubGroup.Update(obj, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Delete(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);                
                objMsg = RepoItemSubGroup.Delete(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
        ...
        public IActionResult Enable(int Id)
        {
            ...
            try
            {
                ...
                if (User == null) return Ok(objMsg);                
                objMsg = RepoItemSubGroup.Enable(Id, User);
            }
            catch (Exception ex)
            {
                Message.Exception(ref objMsg, ex);
