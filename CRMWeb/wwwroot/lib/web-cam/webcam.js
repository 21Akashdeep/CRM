...
/*
For Android If serve has no ssl 
01. Navigate via address-bar to chrome://flags/#unsafely-treat-insecure-origin-as-secure in Chrome.
    Find and enable the Insecure origins treated as secure section.
02. Add any addresses you want to ignore the secure origin policy for. (Include the port number if required.)
03. Save and restart Chrome.
*/